  ...
  return (
    ...
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h4 className="text-lg font-bold mb-4">FashionHub</h4>
          <p className="text-gray-400">Elevating your style with premium fashion selections for men and women.</p>
        </div>
        <div>
          <h5 className="font-semibold mb-4">Shop</h5>
          <ul className="space-y-2">
            <li>
              <a href="#" className="text-gray-400 hover:text-white transition-colors">Women's Collection</a></li>
        ...
        <div>
          ...
          <p className="text-gray-400 mt-4">Sign up for our newsletter for exclusive updates</p>
        </div>
      </div>
